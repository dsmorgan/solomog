...
echo "    Next: demo frontend + httpbin ApiProduct —"
echo "          solomog expose apply BUNDLE=portal-httpbin PRODUCT=kgateway CLUSTER=${CLUSTER}"
echo "          → https://portal.kgw.${CLUSTER}.test/  and  https://api.kgw.${CLUSTER}.test/httpbin/get"
echo "          (or see https://docs.solo.io/kgateway/2.3.x/portal/setup/)"
